...
import 'package:logininstance/app/data/loaders.dart';
// import 'package:marlinpaymain/widgets/loaders.dart';
import 'package:logininstance/tools.dart' as tools;

// ignore: constant_identifier_names
const String BACKEND_URL = "https://api.instagram.com/";
...
class HttpRequest {
  ...
  final NetworkSuccessCallback? failed;
  ...
  NetworkResponse parseResponse(Response? response) {
    ...
    if ('$statusCode'.startsWith('2')) {
      ...
      _onFailed(_response, responseBody);
      return _response;
    }
  }
  ...
  void _onFailed(NetworkResponse response, responseBody) {
    // print('Network success from $url, $result');
    if (failed != null) {
